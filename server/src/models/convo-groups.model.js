...
// convoGroups-model.js - A Sequelize model. (Can be re-generated.)
//
// See http://docs.sequelizejs.com/en/latest/docs/models-definition/
// for more of what you can do here.
const merge = require('lodash.merge')
// !<DEFAULT> code: sequelize_schema
const sequelizeSchema = require('../services/convo-groups/convo-groups.sequelize')
// !end
...
let moduleExports = function (app) {
  ...
  const convoGroups = sequelizeClient.define('convo_groups',
  ...
  convoGroups.associate = function (models) {
  ...
  convoGroups.removeAttribute('id')
  // !end
  return convoGroups
}
