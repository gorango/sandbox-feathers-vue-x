...
// messageReceipts-model.js - A Sequelize model. (Can be re-generated.)
//
// See http://docs.sequelizejs.com/en/latest/docs/models-definition/
// for more of what you can do here.
const merge = require('lodash.merge')
// !<DEFAULT> code: sequelize_schema
const sequelizeSchema = require('../services/message-receipts/message-receipts.sequelize')
// !end
...
let moduleExports = function (app) {
  ...
  const messageReceipts = sequelizeClient.define('message_receipts',
  ...
  messageReceipts.associate = function (models) {
  ...
  messageReceipts.removeAttribute('id')
  // !end
